  ...
  return (
    <>
      ...
      <main className=' max-w-3xl mx-auto p-5 space-y-5 mt-20'>
        ...
        <p className='text-lg'>
          Domina tus finanzas con nuestro Administrador de Gastos. Simplifica la gestión de tus ingresos y egresos en un solo lugar, de manera
          intuitiva y eficiente. Toma el control total de tus finanzas personales o empresariales con nuestra plataforma fácil de usar.
        </p>
      ...
      <nav className='flex flex-col lg:flex-row lg:justify-between gap-5 mt-10 pb-20 max-w-3xl mx-auto '>
        <Link href='/auth/register' className='text-gray-500 text-sm uppercase text-center'>
          ¿No tienes cuenta? Crea una
        </Link>
        <Link href='/auth/login' className='text-gray-500 text-sm uppercase text-center'>
