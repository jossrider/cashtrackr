      ...
      <div className='flex flex-col-reverse md:flex-row md:justify-between items-center'>
        <div className='w-full md:w-auto'>
          ...
          <p className='text-xl font-bold'>
            Maneja y administra tus <span className='text-amber-500'>presupuestos</span>
          </p>
        </div>
        <Link href={'/admin/budgets/new'} className='bg-amber-500 p-2 rounded-lg text-white font-bold w-full md:w-auto text-center'>
          Crear Presupuesto
        </Link>
      </div>
      {budgets.length ? (
              ...
              <li key={budget.id} className='flex justify-between gap-x-6 p-5 '>
                <div className='flex min-w-0 gap-x-4'>
                  <div className='min-w-0 flex-auto space-y-2'>
                    ...
                    <p className='text-xl font-bold text-amber-500'>{formatCurrency(+budget.amount)}</p>
